...
public record ProblemUpdateRequest(
        ...
        @Size(max = 20_000, message = "Description cannot exceed 20,000 characters")
        String description,
        ...
        @Size(max = 10, message = "A problem can contain at most 10 tag names")
        Set<@jakarta.validation.constraints.NotBlank(
                message = "Tag names cannot be blank"
